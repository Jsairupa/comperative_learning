...
train_items = pd.read_csv("Results/train_paintings.csv")
test_items  = pd.read_csv("Results/test_paintings.csv")
...
out.to_csv(f"Results/ridge_predictions_{TARGET}.csv", index=False)
