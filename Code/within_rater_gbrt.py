...
def main():
    ...
    out_csv = CSV_DIR / f"all_raters_{TARGET}_gbrt_scores.csv"
    ...
    out_top2 = CSV_DIR / f"top2_{TARGET}_gbrt.csv"
    ...
    ax.set_title(f"Within-Rater GBRT — Target: {TARGET}")
    ax.set_xlabel("Rater"); ax.set_ylabel("Correlation")
    ax.set_ylim(0, 1)
    ax.legend(); fig.tight_layout()
    png_path = PLOT_DIR / f"all_raters_{TARGET}_gbrt_bar.png"
