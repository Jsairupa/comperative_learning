...
metrics_df = pd.DataFrame([{
    "target": TARGET, "model": "SVR",
    "pearson": pear, "spearman": spear,
    "r2": r2, "adj_r2": adj_r2,
    "mse": mse, "mae": mae
}])
csv_path = CSV_DIR / f"SVR_metrics_{TARGET}.csv"
...
plt.title(f"True vs Predicted — SVR ({TARGET})")
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
plot_path = PLOT_DIR / f"SVR_true_vs_pred_{TARGET}.png"
